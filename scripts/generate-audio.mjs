...
// Vozes-GUIA (falam a língua do aluno — ALEMÃO neste curso: Juli educadora,
// Thomas avisos). Modelo flash: é narração longa, sem exigência de sotaque
// estrangeiro, e custa metade. As vozes-ALVO (espanhol peninsular: Carmen,
// Emilio, e Ivan/Matilda no ear module) caem no multilingual_v2, que segura
// melhor o sotaque. INV-5: guia nunca fala espanhol, nativa nunca fala alemão.
//
// ESTE SET É O QUE SEPARA OS DOIS MODELOS, e é onde o acidente deste repositório
// mora: uma voz-guia que ficasse de fora daqui seria gravada no modelo do alvo, e
// uma voz-alvo que entrasse aqui seria gravada no do guia. Alice e George (as
// guias do curso INGLÊS) não têm nada a fazer nesta lista.
const PT_VOICES = new Set(['Juli', 'Thomas', 'narrador']);
